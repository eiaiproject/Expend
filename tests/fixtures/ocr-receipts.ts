...
export const OCR_RECEIPTS: OcrReceiptFixture[] = [
  ...
  {
    name: 'Jago QRIS merchant: TYA BUAH 2 (bukan acquirer)',
    text: [
      'TYA BUAH 2',
      'JL. RAYA JEMURSA RI NO.39',
      'SURABAYA - JAWA TIMUR',
      'ID Transaksi 260911-0310-3748',
      'Tanggal 11 September 2026',
      'Nominal Rp75.000',
      'Sumber Dana: ANGGIE IRAWAN',
      'Sumber Transaksi: Bank Jago',
      '109581096081',
      'PAN Merchant 9360000812132344533',
      'Nama Acquirer',
      'Bank Mandiri',
      'PAN Pelanggan 936000081213231721',
      '1s6hzqp83790',
      'Biaya Gratis',
      'Sidoarjo (Kab)',
    ].join('\n'),
    expected: { amount: 75000, description: 'Tya Buah 2', source: 'Jago', date: '2026-09-11' },
  },
  {
    name: 'Jago QRIS merchant OCR rusak (Nama Ac r) tetap merchant',
    text: [
      'TYA BUAH 2',
      'JL. RAYA JEMURSA RI NO.39',
      'Nominal Rp75.000',
  ...
  {
    name: 'BCA QRIS merchant: Merchant ID di-skip',
    text: [
      'WARUNG KOPI SUDIANG',
      'Jakarta Selatan',
      'Total Rp 45.000',
    ...
    expected: { amount: 45000, description: 'Warung Kopi Sudiang', source: 'BCA', date: '2026-09-15' },
  },
];
