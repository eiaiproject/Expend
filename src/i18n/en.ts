...
const en: Record<TranslationKey, string> = {
  ...
  'common.loadingProcessor': 'Preparing receipt scanner...',
  'common.ready': 'Ready',
  'common.close': 'Close',
  ...
  'home.cancel': 'Cancel',
  'home.filterDate': 'Filter by date',
  ...
  'chat.useExample': 'Use example {example}',
  'chat.tapExample': 'Tap an example to fill',
  'chat.uploadReceipt': 'Upload transaction receipt',
  'chat.livePreview': 'Detected: {desc} · {amount}',
  'chat.pendingEdit': 'Edit',
  ...
  'chat.inputPlaceholder': 'e.g. coffee 25rb from BSI',
  ...
  'chat.ocrReady': 'Scanner ready',
  'chat.ocrLoading': 'Preparing receipt scanner...',
  ...
  'settings.notEncrypted': 'Data not encrypted',
  'settings.notEncryptedDesc': 'Transaction data is stored in plain text on the device. Anyone with access to the browser/device can read this data.',
