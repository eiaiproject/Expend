...
const en: Record<TranslationKey, string> = {
  ...
  'chat.errorNoLLM': 'Chat mode needs LLM. Enable it in Settings → LLM and fill in API key + model.',
  'chat.errorChatFailed': 'Sorry, I could not answer right now. Try again or check your connection.',
  'chat.thinking': 'Thinking...',
  'chat.welcome': 'Hi! Type an expense (e.g. "coffee 20rb") or ask me anything.',
