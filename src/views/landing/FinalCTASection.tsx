    ...
    <section className="py-16 sm:py-24 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <button
          type="button"
          onClick={onEnter}
          className="px-10 py-4 min-h-[52px] bg-[var(--accent)] text-[var(--bg)] rounded-full font-semibold text-lg hover:opacity-90 transition-opacity active:scale-95 cursor-pointer"
        >
          {t('landing.finalCta')}
        </button>
      </div>
