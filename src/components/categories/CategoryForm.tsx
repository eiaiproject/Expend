    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-end gap-2 pt-2">
        ...
        <button
          ...
          className="flex h-11 items-center justify-center gap-2 px-5 text-sm bg-[var(--accent-fill)] text-white rounded-xl font-medium hover:opacity-90 transition-colors"
        >
