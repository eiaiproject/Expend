    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
        ...
        <button
          type="button"
          onClick={onEnter}
          className="ml-auto inline-flex items-center gap-2 rounded-full bg-[var(--accent)] px-5 py-2.5 min-h-[44px] text-sm font-semibold text-[var(--bg)] hover:opacity-90 transition-opacity active:scale-95 cursor-pointer"
        >
